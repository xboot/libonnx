...
void resolver_default_op_AffineGrid(struct onnx_node_t * n);
void resolver_default_op_Attention(struct onnx_node_t * n);
void resolver_default_op_Bernoulli(struct onnx_node_t * n);
void resolver_default_op_BlackmanWindow(struct onnx_node_t * n);
void resolver_default_op_CastLike(struct onnx_node_t * n);
void resolver_default_op_Celu(struct onnx_node_t * n);
void resolver_default_op_CenterCropPad(struct onnx_node_t * n);
...
void resolver_default_op_Gelu(struct onnx_node_t * n);
...
void resolver_default_op_HannWindow(struct onnx_node_t * n);
void resolver_default_op_HardSigmoid(struct onnx_node_t * n);
void resolver_default_op_HardSwish(struct onnx_node_t * n);
void resolver_default_op_LayerNormalization(struct onnx_node_t * n);
...
void resolver_default_op_Mish(struct onnx_node_t * n);
...
void resolver_default_op_RMSNormalization(struct onnx_node_t * n);
